package com.cavbleu.kh.webcontroller.config;
...
public class SecurityConfig {
    @Value("${application.config.gateway-service-url}")
    ...
    OidcClientInitiatedLogoutSuccessHandler oidcLogoutSuccessHandler(ClientRegistrationRepository clientRegistrationRepository) {
        ...
        successHandler.setPostLogoutRedirectUri(URI.create(gatewayUrl).toString());
